...
## Módulo AC 
ac <- read.dta("rawdata/wave4/stata_sharew4_rel1-1-1_all_capi_modules/sharew4_rel1-1-1_ac.dta")
names(ac)
...
## Módulo IV
iv <- read.dta("rawdata/wave4/stata_sharew4_rel1-1-1_all_capi_modules/sharew4_rel1-1-1_iv.dta")
...
dn <- read.dta("rawdata/wave4/stata_sharew4_rel1-1-1_all_capi_modules/sharew4_rel1-1-1_dn.dta")
...
ph <- read.dta("rawdata/wave4/stata_sharew4_rel1-1-1_all_capi_modules/sharew4_rel1-1-1_ph.dta")
...
## variables generadas gen_ph
  ...
  gen_ph <- read.dta("rawdata/wave4/stata_sharew4_rel1-1-1_all_generated_modules/sharew4_rel1-1-1_gv_health.dta")
...
cf<- read.dta("rawdata/wave4/stata_sharew4_rel1-1-1_all_capi_modules/sharew4_rel1-1-1_cf.dta")
...
mh<- read.dta("rawdata/wave4/stata_sharew4_rel1-1-1_all_capi_modules/sharew4_rel1-1-1_mh.dta")
...
ep<- read.dta("rawdata/wave4/stata_sharew4_rel1-1-1_all_capi_modules/sharew4_rel1-1-1_ep.dta")
