...
## Módulo AC 
ac <- read.dta("rawdata/wave1/stata_sharew1_rel2-6-0__all_capi_modules/sharew1_rel2-6-0_ac.dta")
names(ac)
...
iv <- read.dta("rawdata/wave1/stata_sharew1_rel2-6-0__all_capi_modules/sharew1_rel2-6-0_iv.dta")
...
dn <- read.dta("rawdata/wave1/stata_sharew1_rel2-6-0__all_capi_modules/sharew1_rel2-6-0_dn.dta")
...
ph <- read.dta("rawdata/wave1/stata_sharew1_rel2-6-0__all_capi_modules/sharew1_rel2-6-0_ph.dta")
...
gen_ph <- read.dta("rawdata/wave1/stata_sharew1_rel2-6-0__all_generated_variables_modules/sharew1_rel2-6-0_gv_health.dta")
...
cf<- read.dta("rawdata/wave1/stata_sharew1_rel2-6-0__all_capi_modules/sharew1_rel2-6-0_cf.dta")
...
mh<- read.dta("rawdata/wave1/stata_sharew1_rel2-6-0__all_capi_modules/sharew1_rel2-6-0_mh.dta")
...
ep<- read.dta("rawdata/wave1/stata_sharew1_rel2-6-0__all_capi_modules/sharew1_rel2-6-0_ep.dta")
